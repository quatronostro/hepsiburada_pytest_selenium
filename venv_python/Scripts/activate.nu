...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Berke\PycharmProjects\hepsiburada_test\venv_python'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Berke\PycharmProjects\hepsiburada_test\venv_python\Scripts\deactivate.nu'
